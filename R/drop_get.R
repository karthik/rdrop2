...
#'}
drop_get <- function(path = NULL, local_file = NULL, overwrite = FALSE) {
    ...
    GET(full_download_path, , config(token = get_dropbox_token()), write_disk(filename, overwrite = overwrite))
}
